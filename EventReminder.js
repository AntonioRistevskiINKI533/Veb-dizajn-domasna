...
//sdiv.setAttribute("id",classVar);
//sdiv2.setAttribute("id",classVar);
//sdiv3.setAttribute("id",classVar);
...
//sb.removeEventListener("click",saveEvent);
...
const cf=document.getElementById("btns");
cf.appendChild(newButton);
//sb.removeEventListener("click",f);
